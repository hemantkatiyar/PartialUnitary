function [gooddirc,maxmult] = ConjugateGradDecomss(resetflag,nSpin,iter,grad,oldgrad,olddirc,Fid,x,stepsize,Iz,Had,Hint,nSec,VarPerSec,DelayControl,Utarg,nSub,nSpinT,SubS)
...
for j=2:1:3
    ...
    FidTemp(j) = CalcFidDecomss(xTemp,nSpin,nSec,VarPerSec,DelayControl,Iz,Had,Hint,Utarg,nSub,nSpinT,SubS);
end
