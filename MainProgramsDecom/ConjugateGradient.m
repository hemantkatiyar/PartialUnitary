function [gooddirc,maxmult] = ConjugateGradient(resetflag,nSpin,iter,grad,oldgrad,olddirc,Fid,x,stepsize,Iz,Had,Hint,nSec,VarPerSec,DelayControl,Utarg)
...
for j=2:1:3
    ...
    FidTemp(j) = CalcFid(MakeUnitary(xTemp,nSpin,nSec,VarPerSec,DelayControl,Iz,Had,Hint),Utarg,nSpin);
end
